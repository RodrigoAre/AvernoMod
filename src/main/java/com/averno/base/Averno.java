...
public class Averno {
	...
	/**
	 * Esta anotación le dice a Forge qué debe cargar dependiendo de si el mod
	 * es cargado desde el lado del cliente o o desde el servidor.</br>
	 * Dependiendo de cuál sea la carga que deba hacer invocará a una clase
	...
	/**
	 * Este método es el primero en ejecutarse, en él debemos registrar todo lo
	 ...
	 * todas las cargas, limitando este método a una línea de código.
	 * 
	 * @param event
	 * @see Registro
	 */
